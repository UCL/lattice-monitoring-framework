...
public class WSProducer1 {
     ...
     */
    public WSProducer1(String addr, int dataPort, String myHostname) {
	// set up data source
	...
	if (args.length == 0) {
	    ...
	    System.err.println("WSProducer1 address port");
	    System.exit(1);
	}
	...
	// we got a hostname
	WSProducer1 producer = new WSProducer1(addr, port, currentHost);
