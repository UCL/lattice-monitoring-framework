 ...
 */
public class UDPProducer1 {
    // The DataSource
    DataSource ds;

    /*
     * Construct a UDPProducer1.
     */
    public UDPProducer1(String addr, int dataPort, String myHostname) {
	// set up data source
	...
	// set up data plane
	ds.setDataPlane(new UDPDataPlaneProducerWithNames(address));
	...
	if (args.length == 0) {
	    ...
	    System.err.println("UDPProducer1 address port");
	    System.exit(1);
	}
	...
	// we got a hostname
	UDPProducer1 producer = new UDPProducer1(addr, port, currentHost);
