 ...
 */
public class WSProducerJSON2 {
    // The DataSource
    DataSource ds;

    /*
     * Construct a WSProducerJSON2.
     */
    public WSProducerJSON2(String addr, int dataPort, String myHostname) {
	// set up data source
	...
	if (args.length == 0) {
	    ...
	    System.err.println("WSProducerJSON2 address port");
	    System.exit(1);
	}
	...
	// we got a hostname
	WSProducerJSON2 producer = new WSProducerJSON2(addr, port, currentHost);
