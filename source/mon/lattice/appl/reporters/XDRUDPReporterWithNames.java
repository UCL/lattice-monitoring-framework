 ...
 */
public class XDRUDPReporterWithNames extends AbstractXDREncoderReporterWithNames {
    /*
    ...
    private static Logger LOGGER = LoggerFactory.getLogger(XDRUDPReporterWithNames.class);
 ...
 parameters are all passed as String to allow dynamic loading from REST API
    ...
    public XDRUDPReporterWithNames(String reporterName, String addr, String port) throws IOException {        
     ...
     */
    public XDRUDPReporterWithNames(String reporterName, InetSocketAddress dstAddr) throws IOException {
        super(reporterName); 
	//wsAddr = dstAddr;
     ...
     * Construct a WebSocketReporter for a particular IP dstAddress
     */
    public XDRUDPReporterWithNames(String reporterName, InetAddress addr, int port) throws IOException {
        super(reporterName); 
