 ...
 */
public class XDRUDPReporter extends AbstractXDREncoderReporter {
    /*
    ...
    private static Logger LOGGER = LoggerFactory.getLogger(XDRUDPReporter.class);
 ...
 parameters are all passed as String to allow dynamic loading from REST API
    ...
    public XDRUDPReporter(String reporterName, String addr, String port) throws IOException {        
     ...
     */
    public XDRUDPReporter(String reporterName, InetSocketAddress dstAddr) throws IOException {
        super(reporterName); 
	//wsAddr = dstAddr;
     ...
     * Construct a WebSocketReporter for a particular IP dstAddress
     */
    public XDRUDPReporter(String reporterName, InetAddress addr, int port) throws IOException {
        super(reporterName); 
