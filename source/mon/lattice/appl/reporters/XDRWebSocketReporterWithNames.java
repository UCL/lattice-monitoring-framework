 ...
 */
public class XDRWebSocketReporterWithNames extends AbstractXDREncoderReporterWithNames {
    /*
    ...
    private static Logger LOGGER = LoggerFactory.getLogger(XDRWebSocketReporterWithNames.class);
    ...
    public XDRWebSocketReporterWithNames(String reporterName, String addr, String port) throws IOException {        
     ...
     */
    public XDRWebSocketReporterWithNames(String reporterName, InetSocketAddress dstAddr) throws IOException {
        super(reporterName); 
	wsAddr = dstAddr;
     ...
     * Construct a WebSocketReporter for a particular IP address
     */
    public XDRWebSocketReporterWithNames(String reporterName, InetAddress addr, int port) throws IOException {
        super(reporterName); 
