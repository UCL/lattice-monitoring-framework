 ...
 * 
 * This reports ProcessInfo measurements generated by the probe
 * mon.lattice.appl.probes.host.linux.ProcessInfo
 */
public class ProcessInfoReporter extends AbstractControllableReporter implements ReporterMeasurementType {
    ...
    public void report(Measurement m) {
        ...
        // cpu
        ProbeValue cpu = getAttribute("cpu-percent");
        
        // cpu average
        ProbeValue cpuAvg = getAttribute("cpu-average");
        
        // mem
        ProbeValue mem = getAttribute("proc-rss");


        String cpuLine = timestamp.value() + " " + Timestamp.elapsed(elapsed) + " C " + hostname.getValue() + " " + pid.getValue() + " " + cpu.getValue();
        String cpuAvgLine = timestamp.value() + " " + Timestamp.elapsed(elapsed) + " CA " + hostname.getValue() + " " + pid.getValue() + " " + cpuAvg.getValue();
        ...
        Logger.getLogger("processinfo").logln(MASK.APP, cpuAvgLine);
