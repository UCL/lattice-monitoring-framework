...
public class ZMQSubscriberWithNoMessageOnRemoveProbe extends AbstractZMQSubscriber implements IMSubscriberNode, Runnable {
    ...
    static Logger LOGGER = LoggerFactory.getLogger(ZMQSubscriberWithNoMessageOnRemoveProbe.class);
     ...
     */
    public ZMQSubscriberWithNoMessageOnRemoveProbe(String remHost, int remPort, String filter, ZContext context) {
     ...
     * port where connecting to, a message filter and an existing ZContext.
     */
    public ZMQSubscriberWithNoMessageOnRemoveProbe(String internalURI, String filter, ZContext context) {
    ...
    public ZMQSubscriberWithNoMessageOnRemoveProbe(int port, String filter, ZContext context) {
