 ...
 * @author uceeftu
 */
public class ControlEndPointMetaDataFactory {
    
    
    public static ControlEndPointMetaData newInstance(Object rawControlEndPointInfo, ID entityID) throws IOException {
