// ConsumerMeasurementEncoderWithMetaDataJSON.java
 ...
 * This is similar to ConsumerMeasurementEncoderJSON, but it also used the Meta Data 
 * to add on the Data Source ID, the Data Source seqNo, and the Message type.
 *
 * This extra data is useful in some contexts.
 */
public class ConsumerMeasurementEncoderWithMetaDataJSON {
    // The Measurement
    ...
    /**
     * Construct a ConsumerMeasurementEncoderWithMetaDataJSON for a Measurement.
     */
    public ConsumerMeasurementEncoderWithMetaDataJSON(ConsumerMeasurement m) {
	measurement = m;
    }

    public ConsumerMeasurementEncoderWithMetaDataJSON(Measurement m) {
    ...
    public void encode(JSONObject json) throws JSONException, TypeException {
        ...
        ConsumerMeasurementEncoderJSON encoder = new ConsumerMeasurementEncoderJSON(cm);
