...
public class WSDataPlaneConsumerJSONSimpleProfiled extends WSDataPlaneConsumerJSONSimple {
    
    double mean = 0;
    long n = 0;

    public WSDataPlaneConsumerJSONSimpleProfiled(InetSocketAddress addr) {
        super(addr);
    }

    public WSDataPlaneConsumerJSONSimpleProfiled(int port) {
        super(port);
    }
